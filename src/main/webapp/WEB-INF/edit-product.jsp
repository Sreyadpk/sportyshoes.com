	...
	<div style="padding-top: 30px" class="panel-body">
		...
		<form:form modelAttribute="product" method="post" class="form-horizontal">
            ...
            <div class="form-group">
				...
				<form:input path="productbrand" type="text" value="${product.productbrand}" class="form-control"
			...
			<div class="form-group">
				...
				<form:input path="productprice" type="number" value="${product.productprice}" class="form-control"
			...
			<div class="form-group">
				...
				<form:input path="productseller" type="text" value="${product.productseller}" class="form-control"
			...
			<div class="form-group">
				...
				<form:input path="productcount" type="number" value="${product.productcount}" class="form-control"
			...
			<div style="margin-top: 10px" class="form-group" align='center'>
				...
				<div class="col-sm-12 controls">
					<form:button type='success' class="btn btn-success">update Product </form:button>
				</div>
			</div>
		</form:form>
	</div>
