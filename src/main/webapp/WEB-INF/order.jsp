...
<body>
	...
	<div class="container">
		<div class="row">
		    <h2 align="justify">Order Received</h2>
		    <h3 align="justify">Product * Quantity</h3>
			<c:forEach items="${prodorder}" var="prodorder">
				
					<c:set var="product" value="${prodorder.product}" />
					<div align="justify"><p>${product.productname} </p>
					<p>${product.productprice} * ${prodorder.quantity}</p></div>
				<c:set var="user" value="${prodorder.user}" />
			</c:forEach>
		</div>
		<br>
		<br>
